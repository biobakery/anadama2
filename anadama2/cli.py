...
class Configuration(object):
    ...
    def get_default_options(cls):
        return [
            ...
            ("input", cls.Argument("-i", "--input", default=os.getcwd()+"/input/", 
                help="Find inputs in this directory \n[default: %(default)s]")),
            ("config", cls.Argument(None, "--config", default=os.getcwd()+"/etc/", 
                help="Find workflow configuration in this folder \n[default: only use command line options]")),
            ("scripts", cls.Argument(None, "--scripts", default=os.getcwd()+"/src/", 
                help="Find location of utility scripts \n[default: %(default)s]")),
            ("temp", cls.Argument(None, "--temp", default=os.getcwd()+"/temp/", 
                help="Find location of temp folder \n[default: %(default)s]")),

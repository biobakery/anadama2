    ...
    def _get_grid(self):
        ...
        if grid_jobs == 0:
            ...
            grid = Slurm(partition=grid_partition, tmpdir=tmpdir, benchmark_on = grid_benchmark_setting,
                options=grid_options, environment=grid_environment, output_dir = os.path.abspath(self.vars.get("output")), scratch=grid_scratch, time_max=grid_time_max, mem_max=grid_mem_max)
